...
namespace App\Filament\App\Resources\Lotofacil\EstrategiaFechamentos\RelationManagers;
...
class EstrategiaJogosRelationManager extends RelationManager
{
    ...
    public static function executeBackgroundBot(string $action, string $ids, string $model = 'estrategia'): void
    {
            ...
            ->actions([
                \Filament\Actions\Action::make('apostar')
                    ...
                    ->action(function ($record) {
                        try {
                            static::executeBackgroundBot('lancar', (string) $record->id, 'estrategia');
                ...
                \Filament\Actions\BulkActionGroup::make([
                    \Filament\Actions\BulkAction::make('apostar_selecionados')
                        ...
                        ->action(function (\Illuminate\Database\Eloquent\Collection $records, $livewire = null) {
                            ...
                            try {
                                static::executeBackgroundBot('lancar', implode(',', $ids), 'estrategia');
